 ...
 * @version 1.0
 */
public class AddProjectUsers extends Utility {

    static public void usage() {
	fatal("USage: AddProjectUsers project perms user ... ");
    }
	...
	try {
	    ...
	    ProjectsStub.AddUsers req = new ProjectsStub.AddUsers();

	    req.setProjectid(args[0]);
	    req.setPerms(tags);
	    req.setUids(Arrays.copyOfRange(args, 2, args.length));

	    ProjectsStub.AddUsersResponse resp = stub.addUsers(req);
