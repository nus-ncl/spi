 ...
 * @version 1.0
 */
public class ChangeCirclePermissions extends Utility {

    static public void usage() {
	fatal("Usage: ChangeCirclePermissions circle perms user ... ");
    }
	...
	try {
	    ...
	    CirclesStub.ChangePermissions req = 
	    ...
	    CirclesStub.ChangePermissionsResponse resp = 
